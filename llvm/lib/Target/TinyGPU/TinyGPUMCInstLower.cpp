//===-- TinyGPUMCInstLower.cpp - Convert TinyGPU MachineInstr to MCInst -------===//
//
...
static MCOperand LowerSymbolOperand(const MachineInstr *MI,
  ...
  TinyGPUMCExpr::VariantKind Kind =
    (TinyGPUMCExpr::VariantKind)MO.getTargetFlags();
  ...
  const MCSymbolRefExpr *MCSym = MCSymbolRefExpr::create(Symbol,
                                                         AP.OutContext);
  const TinyGPUMCExpr *expr = TinyGPUMCExpr::create(Kind, MCSym,
                                                AP.OutContext);
